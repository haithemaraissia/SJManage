<%@ Page CodeFile="Register.aspx.cs" Title="" Language="C#" MasterPageFile="~/Plain.master"
    AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="Account.Register" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <title runat="server" title="<%$ Resources:Resource, CreateNewAccount %>"></title>
    <style type="text/css">
        .ProfileRightColumn
        {
            width: 170px;
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:ToolkitScriptManager ID="ScriptManager1" runat="server">
        ...
        <asp:CreateUserWizard ID="SignUpCreateWizard" runat="server" ContinueDestinationPageUrl="~/Management/Profile/ViewProfile.aspx"
            DisableCreatedUser="false" Font-Names="Verdana" BackColor="white" Font-Size="10pt"
            CompleteSuccessText="<%$ Resources:Resource, SuccessfulRegistration %>" UnknownErrorMessage="<%$ Resources:Resource, FailureRegistration %>"
            OnCreatedUser="SignUpCreateWizardCreatedUser" ActiveStepIndex="0">
            <WizardSteps>
                        ...
                        <table style="font-size: 10pt; font-family: Verdana" border="0" width="820" cellpadding="5px">
                            ...
                            <tr>
                                ...
                                <td class="ProfileLeftColumn">
                                    <asp:DropDownList ID="Gender" runat="server" Width="150px">
                                        <asp:ListItem Value="1" Text="<%$ Resources:Resource, Male %>" Selected="true"></asp:ListItem>
                            ...
                            <tr>
                                <td align="right" class="ProfileRightColumn">
                                    ...
                                    <asp:ValidatorCalloutExtender ID="EmailExpressionValidatorExtender" runat="server" TargetControlID="EmailAddressRegularExpressionValidator">
                                    </asp:ValidatorCalloutExtender>
                                ...
                                <td style="text-align: left">
                                    <asp:TextBox ID="CompanyURL" runat="server" Style="text-align: left; left: 18px;
                                        ...
                                        ErrorMessage="<%$ Resources:Resource, ValidURL %>" Display="none" />
                                         <asp:ValidatorCalloutExtender ID="ValidURLValidatorCalloutExtender" runat="server" TargetControlID="CompanyURLRegularExpressionValidator">
                                    </asp:ValidatorCalloutExtender>
                                </td>
                            </tr>
                            <tr>
