<%@ Page Title="" Language="C#" MasterPageFile="~/Plain.master" AutoEventWireup="true" CodeFile="ArchievedProfessionalSuccessfulPDT.aspx.cs" Inherits="Management_Transaction_Professional_ArchievedProfessionalSuccessfulPDT" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div>
        ...
        <asp:GridView runat="server" AllowPaging="True" AllowSorting="True"
            AutoGenerateColumns="False" DataKeyNames="PDTID" DataSourceID="ArchievedProfessionalSuccessfulPDTSqlDataSource">
            <Columns>
        ...
        <asp:SqlDataSource ID="ArchievedProfessionalSuccessfulPDTSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:SideJobConnectionString %>"
            SelectCommand="SELECT * FROM [ArchivedProfessionalSuccessfulPDT]"></asp:SqlDataSource>
    </div>
</asp:Content>
