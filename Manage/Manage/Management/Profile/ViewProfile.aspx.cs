    ...
    public partial class AdvertiserProfileViewProfile : System.Web.UI.Page
    {
        protected override void InitializeCulture()
        {
            ...
            else
            {
                ...
                {
                    Thread.CurrentThread.CurrentUICulture = new CultureInfo(ManageUtility.GetLanguage(Convert.ToInt32(Session["LCID"])));
                    Thread.CurrentThread.CurrentCulture = CultureInfo.CreateSpecificCulture(ManageUtility.GetLanguage(Convert.ToInt32(Session["LCID"])));
                }
            }
        ...
        private void GetAttributes()
        {
            ...
            Industry.Text = ManageUtility.GetIndustryById(Convert.ToInt32(Profile.Industry), Convert.ToInt32(Session["LCID"].ToString()));
            ...
            CountryImage.ImageUrl = ManageUtility.GetFlagPath(Profile.CountryID);
